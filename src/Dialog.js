...
const Dialogbox = () => {
  ...
  return (
    <div >
      <div className="theme-btn-1 btn btn-effect-1" style={{padding:"10px",borderRadius:"10px",fontSize:"16px",fontWeight:"600"}} onClick={handleClickOpen}>Schedule Visit
      </div>
      ...
      <div>
        <div>
          <div style={{height:"400px",width:"380px",border:"5px solid #c1a356"}}>
            <h2 style={{marginLeft:"30px"}}>To Schedule a Visit</h2>
