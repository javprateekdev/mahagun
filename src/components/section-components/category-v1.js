...
class CategoryV1 extends Component {
    ...
    return <div className="ltn__category-area ltn__product-gutter section-bg-1--- pt-115 pb-90 go-top" id='amenities'>
			  <div className="container">
			    <div className="row">
			      <div className="col-lg-12">
			        <div className="section-title-area ltn__section-title-2--- text-center">
			          <h6 className="section-subtitle section-subtitle-2 ltn__secondary-color">Our  Amenities</h6>
			          <h1 className="section-title">Mahagun Medalleo Amenities</h1>
			        </div>
			      </div>
			    </div>
