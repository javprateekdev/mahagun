...
class CallToActonV2 extends Component {
    ...
    return <div className="ltn__call-to-action-area ltn__call-to-action-4 bg-image pt-115 pb-120 " data-bs-bg={"https://i.imgur.com/aXL7tAt.png"}>
				...
				<div className="row">
					...
					<div className="call-to-action-inner call-to-action-inner-4 text-center">
						...
						<h1 className="section-title black-color">+91-81-3030-6040</h1>
						</div>
						<div className="btn-wrapper">
						<a href="tel:+918130306040" className="theme-btn-1 btn btn-effect-1" >MAKE A CALL</a>
