...
const Dialogbox = () => {
  ...
  return (
    <div >
      <div className="theme-btn-1 btn btn-effect-1" style={{padding:"10px",borderRadius:"10px",fontSize:"16px",fontWeight:"600"}} onClick={handleClickOpen}>Download Brochure
      </div>
      ...
      <div>
        <div>
          <div style={{height:"420px",width:"380px",border:"5px solid #c1a356"}}>
            ...
            <h2 style={{marginLeft:"100px"}}> Brochure</h2>
            <div >
